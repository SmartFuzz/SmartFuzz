...
string IR::to_string() {
  ...
  if (type_ == kIntLiteral) return left_comment + " " + std::to_string(int_val_) + " " + right_comment;
  if (type_ == kFloatLiteral || type_ == kconst_float)
    return left_comment + " " + std::to_string(f_val_) + " " + right_comment;
  if (type_ == kconst_str) return left_comment + " " + str_val_ + " " + right_comment;
  if (type_ == kconst_int) return left_comment + " " + std::to_string(int_val_) + " " + right_comment;

  if (!str_val_.empty()) return left_comment + " " + str_val_ + " " + right_comment;
  res += left_comment;
