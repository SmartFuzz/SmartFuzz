...
%union HSQL_STYPE {
  ...
  std::vector<WithDescription*>* with_description_vec;
     ...
     ** Token Definition
     *********************************/
    %token<sval> STRING IDENTIFIER COMMENTLITERAL
    %token<fval> FLOATVAL 
    %token<ival> INTVAL
...
%type <comment_literal_t>	comment_literal
...
| comment_literal cmd_release {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  cmd_release comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal cmd_pragma {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  cmd_pragma comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal cmd_reindex {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  cmd_reindex comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal cmd_analyze {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  cmd_analyze comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal cmd_attach {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  cmd_attach comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal cmd_detach {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  cmd_detach comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} ;
...
| comment_literal pragma_value {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  pragma_value comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal rollback_statement {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  rollback_statement comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal opt_transaction {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_transaction comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal opt_to_savepoint {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_to_savepoint comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal vacuum_statement {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  vacuum_statement comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal begin_statement {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  begin_statement comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal commit_statement {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  commit_statement comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal upsert_clause {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  upsert_clause comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal opt_collate {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_collate comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal opt_null {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_null comment_literal {
  $$ = $1;
  $$->right_comment_ = $2;
} 
...
| comment_literal opt_hints {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_hints comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal hint {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  hint comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal prepare_statement {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  prepare_statement comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
...
| comment_literal prepare_target_query {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  prepare_target_query comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal execute_statement {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  execute_statement comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
...
| comment_literal import_statement {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  import_statement comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal import_file_type {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  import_file_type comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal show_statement {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  show_statement comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal alter_statement {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  alter_statement comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal opt_column {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_column comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal create_statement {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  create_statement comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal opt_unique {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_unique comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal opt_tmp {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_tmp comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal opt_trigger_time {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_trigger_time comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal trigger_event {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  trigger_event comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal opt_of_column_list {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_of_column_list comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
...
| comment_literal opt_for_each {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_for_each comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
...
| comment_literal opt_when {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_when comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal trigger_cmd_list {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  trigger_cmd_list comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal opt_not_exists {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_not_exists comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal column_def_commalist {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  column_def_commalist comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal opt_column_arglist {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_column_arglist comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal column_arg {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  column_arg comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal opt_on_conflict {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_on_conflict comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
}
...
| comment_literal resolve_type {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  resolve_type comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal opt_autoinc {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_autoinc comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal column_type {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  column_type comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal drop_statement {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  drop_statement comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal opt_exists {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_exists comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal delete_statement {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  delete_statement comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal truncate_statement {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  truncate_statement comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} ;
...
| comment_literal super_list {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  super_list comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal insert_type {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  insert_type comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal opt_column_list {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_column_list comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal update_statement {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  update_statement comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal update_clause {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  update_clause comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal select_no_paren {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  select_no_paren comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal set_type {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  set_type comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal opt_all {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_all comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal select_clause {
    // fprintf(stdout,"reach first comment");
		$$ = $2;
		$$->left_comment_ = $1;
}
|  select_clause comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal window_clause {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  window_clause comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal windowdefn {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  windowdefn comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal opt_base_window_name {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_base_window_name comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal opt_frame {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_frame comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal range_or_rows {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  range_or_rows comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal frame_bound_s {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  frame_bound_s comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal frame_bound_e {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  frame_bound_e comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal frame_bound {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  frame_bound comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal opt_frame_exclude {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_frame_exclude comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal frame_exclude {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  frame_exclude comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal opt_distinct {
		$$ = $2;
		$$->left_comment_ = $1;
}
| opt_distinct comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal from_clause {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  from_clause comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal opt_where {
		$$ = $2;
		$$->left_comment_ = $1;
	}
|  opt_where comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal opt_group {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_group comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	} 
;
...
| comment_literal opt_having {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_having comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal opt_order {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_order comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal order_list {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  order_list comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	} 
;
...
| comment_literal opt_order_type {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_order_type comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	} 
;
...
| comment_literal opt_top {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_top comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| /* empty */ { $$ = nullptr; }
| comment_literal opt_limit {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_limit comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal expr_list {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  expr_list comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	} 
;
...
| comment_literal opt_literal_list {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_literal_list comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	} 
;
...
| comment_literal literal_list {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  literal_list comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	} 
;
...
| comment_literal operand {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  operand comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal cast_expr {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  cast_expr comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal unary_expr {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  unary_expr comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal in_expr {
		$$ = $2;
		$$->left_comment_ = $1;
	}
|  in_expr comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal case_expr {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  case_expr comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	} 
;
...
| comment_literal case_list {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  case_list comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	} 
;
...
| comment_literal exists_expr {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  exists_expr comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	} 
;
...
| comment_literal function_expr {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  function_expr comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	} 
;
...
| comment_literal opt_over_clause {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_over_clause comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	} 
;
...
| comment_literal opt_filter_clause {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_filter_clause comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	} 
;
...
| comment_literal extract_expr {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  extract_expr comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	} 
;
...
| comment_literal datetime_field {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  datetime_field comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal array_expr {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  array_expr comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal array_index {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  array_index comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	} ;
...
| IDENTIFIER '.' '*' {
 ...
 | comment_literal column_name {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  column_name comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	} ;
...
| comment_literal string_literal {
  $$ = $2;
  $$->left_comment_ = $1;
}
|  string_literal comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal bool_literal {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  bool_literal comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal num_literal {
		$$ = $2;
		$$->left_comment_ = $1;
	}
|  num_literal comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal int_literal {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  int_literal comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal null_literal {
  $$ = $2;
  $$->left_comment_ = $1;
}
|  null_literal comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
comment_literal :
      ...
      // fprintf(stderr,"2222%s\n",$2);
			$$->string_vals_.push_back($2);
		}
	;
param_expr : '?' { $$ = new ParamExpr(); }
| comment_literal param_expr {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  param_expr comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	} 
;
...
| comment_literal table_prefix {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  table_prefix comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	} 
  ;
...
| comment_literal join_op {
		$$ = $2;
		$$->left_comment_ = $1;
	}
| join_op comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	} 
;
...
| comment_literal opt_index {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_index comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	} 
;
...
| comment_literal opt_on {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_on comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal opt_using {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  opt_using comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal table_name {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  table_name comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal alias {
		$$ = $2;
		$$->left_comment_ = $1;
	}
|  alias comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
;
...
| comment_literal with_description_list {
		$$ = $2;
		$$->left_comment_ = $1;
}
|  with_description_list comment_literal{
  $$ = $1;
  $$->right_comment_ = $2;
} 
  ;
...
//|   /* empty, default */    { $$ = new JoinKw(); $$->str_val_ = string(""); }
  | comment_literal join_kw {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  join_kw comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	}
;
...
| comment_literal opt_semicolon {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_semicolon comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	} 
;
...
| comment_literal ident_commalist {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  ident_commalist comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	} ;
