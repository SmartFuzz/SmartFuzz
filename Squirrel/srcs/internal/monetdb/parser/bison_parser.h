...
# define FF_TOKENTYPE
  enum ff_tokentype
  {
    ...
    SQL_DATE = 452,                /* DATE  */
    SQL_TIME = 453,                /* TIME  */
    SQL_TIMESTAMP = 454,           /* TIMESTAMP  */
    SQL_inet = 455,                /* inet  */
    SQL_JSON = 456,                /* JSON  */
    SQL_URL = 457,                 /* URL  */
    SQL_uuid = 458,                /* uuid  */
    SQL_INTERVAL = 459,            /* INTERVAL  */
    SQL_INTLITERAL = 460,          /* INTLITERAL  */
    SQL_FLOATLITERAL = 461,        /* FLOATLITERAL  */
    SQL_IDENTIFIER = 462,          /* IDENTIFIER  */
    SQL_STRINGLITERAL = 463,       /* STRINGLITERAL  */
    SQL_COMMENTLITERAL = 464       /* COMMENTLITERAL  */
  };
