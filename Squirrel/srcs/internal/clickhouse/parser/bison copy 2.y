    ...
    do {                                                  \
        if ((DEST)->right_comment_ != NULL) {              \
            (DEST)->right_comment_->string_vals_.insert(   \
                (DEST)->right_comment_->string_vals_.begin(), \
                (SRC)->string_vals_.begin(),              \
                (SRC)->string_vals_.end()                 \
            );                                             \
        } else {                                          \
...
stmtlist:
   ...
   |	stmt OP_SEMI  {
	...
	| comment_literal stmtlist {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  stmtlist comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	}
...
alter_stmt:
	...
	| comment_literal alter_stmt {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  alter_stmt comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
select_with_parens:
   ...
   |	OP_LP select_with_parens OP_RP  {
	...
	| comment_literal select_with_parens {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  select_with_parens comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
combine_clause:
   ...
   |	EXCEPT  {
	...
	| comment_literal combine_clause {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  combine_clause comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
window_def:
	...
	| comment_literal window_def {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  window_def comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
opt_partition:
	...
	| comment_literal opt_partition {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_partition comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
frame_bound_start:
   ...
   |	UNBOUNDED PRECEDING  {
	...
	| comment_literal frame_bound_start {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  frame_bound_start comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
frame_bound_end:
   ...
   |	UNBOUNDED FOLLOWING  {
	...
	| comment_literal frame_bound_end {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  frame_bound_end comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
opt_group_clause:
   ...
   |	  {
	...
	| comment_literal opt_group_clause {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_group_clause comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
opt_having_clause:
   ...
   |	  {
	...
	| comment_literal opt_having_clause {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_having_clause comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
where_clause:
	...
	| comment_literal where_clause {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  where_clause comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
opt_join_type:
   ...
   |	  {
	...
	| comment_literal opt_join_type {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_join_type comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
limit_clause:
   ...
   |	LIMIT expr OP_COMMA expr  {
	...
	| comment_literal limit_clause {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  limit_clause comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
opt_limit_row_count:
   ...
   |	  {
	...
	| comment_literal opt_limit_row_count {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_limit_row_count comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
opt_order_clause:
   ...
   |	  {
	...
	| comment_literal opt_order_clause {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_order_clause comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
opt_order_nulls:
   ...
   |	  {
	...
	| comment_literal opt_order_nulls {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_order_nulls comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
opt_order_behavior:
   ...
   |	  {
	...
	| comment_literal opt_order_behavior {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_order_behavior comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
opt_with_clause:
   ...
   |	  {
	...
	| comment_literal opt_with_clause {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_with_clause comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
cte_table:
	...
	| comment_literal cte_table {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  cte_table comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
opt_all_or_distinct:
   ...
   |	  {
	...
	| comment_literal opt_all_or_distinct {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_all_or_distinct comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
create_table_stmt:
   ...
   |	CREATE opt_temp TABLE opt_if_not_exist table_name OP_LP column_def_list opt_table_constraint_list OP_RP opt_table_option_list  {
	...
	| comment_literal create_table_stmt {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  create_table_stmt comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
create_index_stmt:
	...
	| comment_literal create_index_stmt {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  create_index_stmt comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
create_trigger_stmt:
	...
	| comment_literal create_trigger_stmt {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  create_trigger_stmt comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
create_view_stmt:
   ...
   |	CREATE OR REPLACE opt_view_algorithm opt_sql_security VIEW view_name opt_column_name_list_p AS select_stmt opt_check_option  {
	...
	| comment_literal create_view_stmt {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  create_view_stmt comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
opt_table_option_list:
   ...
   |	  {
	...
	| comment_literal opt_table_option_list {
		// TOFIX
		$$ = $2;
		...
		// else {$$->left_comment_ = $1;}
		MERGE_LEFT_COMMENT($$, $1);
		// std::cout<< "left_comment_ after" <<$$->left_comment_->to_string()<<std::endl;
	}
	|  opt_table_option_list comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
...
table_option:
   ...
   |	ROW_FORMAT opt_op_equal COMPACT  {
	...
	| comment_literal table_option {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  table_option comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
opt_op_comma:
   ...
   |	  {
	...
	| comment_literal opt_op_comma {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_op_comma comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
opt_ignore_or_replace:
   ...
   |	  {
	...
	| comment_literal opt_ignore_or_replace {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_ignore_or_replace comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
opt_view_algorithm:
   ...
   |	  {
	...
	| comment_literal opt_view_algorithm {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_view_algorithm comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
opt_sql_security:
   ...
   |	  {
	...
	| comment_literal opt_sql_security {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_sql_security comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
opt_index_option:
   ...
   |	  {
	...
	| comment_literal opt_index_option {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_index_option comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
index_algorithm_option:
   ...
   |	ALGORITHM opt_op_equal COPY  {
	...
	| comment_literal index_algorithm_option {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  index_algorithm_option comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
lock_option:
   ...
   |	LOCK opt_op_equal EXCLUSIVE  {
	...
	| comment_literal lock_option {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  lock_option comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
opt_op_equal:
   ...
   |	  {
	...
	| comment_literal opt_op_equal {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_op_equal comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
trigger_events:
   ...
   |	UPDATE  {
	...
	| comment_literal trigger_events {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  trigger_events comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
trigger_action_time:
   ...
   |	AFTER  {
	...
	| comment_literal trigger_action_time {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  trigger_action_time comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
drop_index_stmt:
	...
	| comment_literal drop_index_stmt {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  drop_index_stmt comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
drop_table_stmt:
	...
	| comment_literal drop_table_stmt {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  drop_table_stmt comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
opt_restrict_or_cascade:
   ...
   |	  {
	...
	| comment_literal opt_restrict_or_cascade {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_restrict_or_cascade comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
drop_trigger_stmt:
	...
	| comment_literal drop_trigger_stmt {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  drop_trigger_stmt comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
drop_view_stmt:
	...
	| comment_literal drop_view_stmt {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  drop_view_stmt comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
insert_rest:
   ...
   |	opt_column_name_list_p VALUES super_values_list  {
	...
	| comment_literal insert_rest {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  insert_rest comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
values_list:
	...
	| comment_literal values_list {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  values_list comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
opt_conflict_expr:
   ...
   |	  {
	...
	| comment_literal opt_conflict_expr {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_conflict_expr comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
update_stmt:
   ...
   |	UPDATE table_name opt_as_alias SET set_clause_list opt_where_clause opt_order_clause opt_limit_row_count  {
	...
	| comment_literal update_stmt {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  update_stmt comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
alter_action:
   ...
   |	alter_constant_action  {
	...
	| comment_literal alter_action {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  alter_action comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
alter_constant_action:
   ...
   |	WITHOUT VALIDATION  {
	...
	| comment_literal alter_constant_action {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  alter_constant_action comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
opt_check:
   ...
   |	  {
	...
	| comment_literal opt_check {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_check comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
constraint_type:
   ...
   |	UNIQUE  {
	...
	| comment_literal constraint_type {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  constraint_type comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
reference_clause:
	...
	| comment_literal reference_clause {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  reference_clause comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
opt_foreign_key:
   ...
   |	  {
	...
	| comment_literal opt_foreign_key {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_foreign_key comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
foreign_key_actions:
   ...
   |	ON DELETE key_actions  {
	...
	| comment_literal foreign_key_actions {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  foreign_key_actions comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
key_actions:
   ...
   |	NO ACTION  {
	...
	| comment_literal key_actions {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  key_actions comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	}
...
opt_constraint_attribute_spec:
   ...
   |	  {
	...
	| comment_literal opt_constraint_attribute_spec {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_constraint_attribute_spec comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
opt_initial_time:
   ...
   |	  {
	...
	| comment_literal opt_initial_time {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_initial_time comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
constraint_name:
	...
	| comment_literal constraint_name {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  constraint_name comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	}
	| comment_literal constraint_name {
...
opt_temp:
   ...
   |	  {
	...
	| comment_literal opt_temp {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_temp comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
opt_check_option:
   ...
   |	  {
	...
	| comment_literal opt_check_option {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_check_option comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
opt_column_name_list_p:
   ...
   |	  {
	...
	| comment_literal opt_column_name_list_p {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_column_name_list_p comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
set_clause:
   ...
   |	OP_LP column_name_list OP_RP OP_EQUAL expr  {
	...
	| comment_literal set_clause {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  set_clause comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
case_clause:
	...
	| comment_literal case_clause {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  case_clause comment_literal {
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
float_literal:
	...
	| comment_literal float_literal {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  float_literal comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	}
...
opt_if_not_exist:
   ...
   |	  {
	...
	| comment_literal opt_if_not_exist {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_if_not_exist comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	} 
  ;
...
opt_if_exist:
   ...
   |	  {
	...
	| comment_literal opt_if_exist {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_if_exist comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	} 
  ;
...
identifier:
	...
	| comment_literal identifier {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  identifier comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	}
...
as_alias:
	...
	| comment_literal as_alias {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  as_alias comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	} 
  ;
...
opt_index_keyword:
   ...
   |	  {
	...
	| comment_literal opt_index_keyword {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_index_keyword comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	} 
  ;
...
binary_op:
   ...
   |	OP_XOR  {
	...
	| comment_literal binary_op {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  binary_op comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
opt_not:
   ...
   |	  {
	...
	| comment_literal opt_not {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_not comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
character_with_length:
	...
	| comment_literal character_with_length {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  character_with_length comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
character_without_length:
   ...
   |	BINARY  {
	...
	| comment_literal character_without_length {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  character_without_length comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
character_conflicta:
   ...
   |	NCHAR  {
	...
	| comment_literal character_conflicta {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  character_conflicta comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
numeric_type:
   ...
   |	BOOLEAN  {
	...
	| comment_literal numeric_type {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  numeric_type comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
table_constraint:
   ...
   |	constraint_name FOREIGN KEY OP_LP column_name_list OP_RP reference_clause  {
  	...
  	| comment_literal table_constraint {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  table_constraint comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	}
  ;
...
opt_enforced:
   ...
   |	  {
	...
	| comment_literal opt_enforced {
		$$ = $2;
		$$->left_comment_ = $1;
	}
	|  opt_enforced comment_literal{
		$$ = $1;
		$$->right_comment_ = $2;
	}
